  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-12">
      ...
      <div className="bg-gradient-to-r from-[#0b3d2c] via-[#15543e] to-[#0b3d2c] text-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-md relative overflow-hidden">
        ...
        <div className="absolute right-[-20px] bottom-[-20px] opacity-10 pointer-events-none hidden sm:block">
          <Tree size={240} weight="fill" />
        </div>
      </div>

      {/* Metrics Row (2 columns on mobile, 4 columns on desktop) */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 border border-black/5 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
          <div className="space-y-0.5 sm:space-y-1">
            <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-[#111111]/50">
              Total Laporan
            </p>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 border border-black/5 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
          <div className="space-y-0.5 sm:space-y-1">
            ...
            <p className="text-xl sm:text-2xl font-extrabold text-[#111111]">YOLOv8</p>
            <p className="text-[10px] sm:text-[11px] text-[#88d937] font-semibold flex items-center gap-1">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              Sistem AI Siap
            </p>
          </div>
          <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-amber-500/10 text-amber-600 flex items-center justify-center shrink-0">
            <ShieldWarning size={20} weight="duotone" className="sm:hidden" />
            <ShieldWarning size={24} weight="duotone" className="hidden sm:block" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 border border-black/5 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
          <div className="space-y-0.5 sm:space-y-1">
            ...
            <p className="text-xl sm:text-2xl font-extrabold text-[#111111]">Semarang</p>
            <p className="text-[10px] sm:text-[11px] text-[#111111]/60">Jawa Tengah</p>
          </div>
          <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-blue-500/10 text-blue-600 flex items-center justify-center shrink-0">
            <MapPinLine size={20} weight="duotone" className="sm:hidden" />
            <MapPinLine size={24} weight="duotone" className="hidden sm:block" />
          </div>
        </div>
